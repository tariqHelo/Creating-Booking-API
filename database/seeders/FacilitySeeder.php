...
class FacilitySeeder extends Seeder
{
    ...
    public function run(): void
    {
       ...
       // Facility::create(['facility_category_id' => 1, 'name' => 'Linen']);
        ...
        //select from Facility table, and create new FacilityProperty

        //map through Facility table, and create new FacilityProperty
        Facility::all()->map(function ($facility) {
